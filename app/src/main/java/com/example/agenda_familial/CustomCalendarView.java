...
public class CustomCalendarView extends LinearLayout {
    ...
    SimpleDateFormat eventDateFormate = new SimpleDateFormat("yyyy-MM-dd", Locale.FRENCH);
    ...
    int alarmYear, alarmMonths, alarmDay, alarmHour, alarmMinutes;
    ...
    public CustomCalendarView(Context context, @Nullable AttributeSet attrs) {
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                alarmMonths = dateCalendar.get(Calendar.MONTH);
                    ...
                    public void onClick(View view) {
                        ...
                        TimePickerDialog timePickerDialog = new TimePickerDialog(addView.getContext(), R.style.Theme_AppCompat_Dialog, new TimePickerDialog.OnTimeSetListener() {
                            ...
                            public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                                ...
                                SimpleDateFormat hformat = new SimpleDateFormat("K:mm a", Locale.FRENCH);
